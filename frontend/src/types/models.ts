/** Building types in Endfield factory. */
export type BuildingType = 'filler' | 'grinder' | 'molder' | 'refinery' | 'crusher'
...
/** Stream message from solver hub */
export type SolverStreamItem =
  | { type: 'attempt'; data: SolverAttempt }
  | { type: 'solution'; data: LayoutSolution }
